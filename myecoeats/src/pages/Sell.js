...
const Sell = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // create a form data obj to filter out the "values"
      const formData = {
        title: values.title,
      ...
      message.success("Ad submitted for admin review succesfully");
      ...
      // Upload product image and handle errors
      try {
      ...
      console.log(error);
      message.error("Failed submission");
      setConfirmLoading(false);
    }
  };
