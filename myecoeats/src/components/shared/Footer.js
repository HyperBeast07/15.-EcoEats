...
const Footer = () => {
 return (
   <div className="bg-black">
     <div className="p-12">
       <div className="rounded-lg text-gray-900 bg-white p-2 text-3xl inline-block vanBold">
         MyEcoEats.com
       </div>
       ...
       <div className="flex items-center gap-24 text-2xl text-white my-8 sm:text-black">
         <div className="">
           <Link to="/">Home</Link>
         </div>
         <div>
